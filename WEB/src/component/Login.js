...
import { Form, Col, Row, Button, Alert,Nav,Navbar } from "react-bootstrap";
              ...
              (
                <Row className="col-12">
                  <Alert variant="danger" >
                    <Alert.Heading>Ingrese Sesion Para Poder Entrar A La Pagina</Alert.Heading>
                    <p>
                      Debe Ingresar Sesion
        </p>
                  </Alert>
                </Row>
              )
    ...
    return (
      <div >
        ...
        <div>
          ...
          ) : 'INGRESE SESION PARA ACCEDER AL CONTENIDO'}
        </div>
      </div>
